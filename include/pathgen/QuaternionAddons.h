...
Eigen::Quaterniond plus(const Eigen::Quaterniond& q1, const Eigen::Quaterniond& q2)
{
...
Eigen::Quaterniond minus(const Eigen::Quaterniond& q1, const Eigen::Quaterniond& q2)
{
    Eigen::Quaterniond quat;
    quat.coeffs() = q1.coeffs() - q2.coeffs();
    return quat;
...
Eigen::Matrix3d E(const Eigen::Quaterniond& q1, const short sign)
